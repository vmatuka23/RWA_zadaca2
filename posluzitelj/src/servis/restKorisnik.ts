...
export class RestKorisnik {
 ...
 async getKorisnici(zahtjev: Request, odgovor: Response) {
  ...
  async aktivirajKorisnika(zahtjev: Request, odgovor: Response): Promise<void> {
    odgovor.type("application/json");
  ...
  async deaktivirajKorisnika(zahtjev: Request, odgovor: Response): Promise<void> {
    odgovor.type("application/json");
  ...
  async deleteKorisnikById(zahtjev: Request, odgovor: Response): Promise<void> {
    odgovor.type("application/json");
