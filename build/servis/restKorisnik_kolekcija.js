...
export class RestKorisnikKolekcija {
    ...
    async postVeza(req, res) {
        ...
        // Only moderator and admin can assign users to collections
        ...
        try {
            // Validate that user and collection exist
    ...
    async deleteVeza(req, res) {
        ...
        const uloga = req.session.korisnik.uloga;
        // Only moderator and admin can remove users from collections
        if (uloga !== "moderator" && uloga !== "admin") {
    ...
    async getKolekcijeZaKorisnika(req, res) {
        ...
        const uloga = req.session.korisnik.uloga;
        // Only moderator and admin can view these
        if (uloga !== "moderator" && uloga !== "admin") {
